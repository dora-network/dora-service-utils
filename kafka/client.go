...
type Client interface {
	...
	// Produce sens a record to Kafka asynchronously, calling an optional promise with the record written to Kafka and potentially an error if the record failed.
